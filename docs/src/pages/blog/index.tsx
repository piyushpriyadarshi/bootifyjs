...
export default function BlogList(): JSX.Element {
  ...
  return (
    <Layout
      title="Blog"
      description="BootifyJS Blog - Tutorials, updates, and best practices"
    >
      <div className={styles.blogContainer}>
        <header className={styles.blogHeader}>
          <h1>Blog</h1>
          <p>
            Tutorials, updates, and best practices for building with BootifyJS
          </p>
        </header>
            ...
            <article key={post.id} className={styles.postCard}>
              ...
              <div className={styles.postContent}>
                ...
                <h2 className={styles.postTitle}>
                  <Link to={`/blog/post?slug=${post.slug}`}>{post.title}</Link>
                </h2>
